...
var
 ...
 begin
  Wuerfel:=1+Random(100);//Normales Random 100 wäre 0...99
    if aktuellerRaum.Difficulty='Hoehlespinne'
	...
	if aktuellerRaum.Difficulty='Hoehleboss'
     then begin                                         
       if Wuerfel <= 100  then                           
          aktuellerRaum.Enemy:=Riesenspinne;
     end;
	 
	if aktuellerRaum.Difficulty='Wald'
     then begin                                         
       if Wuerfel <= 30  then                           
	...
	if aktuellerRaum.Difficulty='Hoehle'
     then begin                                         
       if Wuerfel <= 80  then                           
          aktuellerRaum.Enemy:=Riesenfledermaus
       else if (Wuerfel > 80) and (Wuerfel <=100)   then
	...
	if aktuellerRaum.Difficulty='Vulkan'
     then begin                                         
       if Wuerfel <= 100  then                           
          aktuellerRaum.Enemy:=Feuerelementar;
     end;
	 
	if aktuellerRaum.Difficulty='Sumpf'
     then begin                                         
       if Wuerfel <= 40  then                           
          aktuellerRaum.Enemy:=Goblin
	...
	if aktuellerRaum.Difficulty='Offene_Landschaft'
     then begin                                         
       if Wuerfel <= 35  then                           
          aktuellerRaum.Enemy:=Bandit
	...
	if aktuellerRaum.Difficulty='Burgstark'
     then begin
       if Wuerfel <= 45  then                           
	...
	if aktuellerRaum.Difficulty='Herberge'
     then begin                                         
       if Wuerfel <= 100  then                           
          aktuellerRaum.Enemy:=Rolf;
     end;
	 
	if aktuellerRaum.Difficulty='Weg'
     then begin                                         
       if Wuerfel <= 30  then                           
          aktuellerRaum.Enemy:=nil
	...
	if aktuellerRaum.Difficulty='Burg'
     then begin                                         
       if Wuerfel <= 60  then                           
	...
	if aktuellerRaum.Difficulty='Wueste'
     then begin                                         
       if Wuerfel <= 70  then                           
	...
	if aktuellerRaum.Difficulty='Goblinstark'
     then begin                                         
       if Wuerfel <= 30  then                           
	...
	if aktuellerRaum.Difficulty='Baer'
     then begin                                         
       if Wuerfel <= 100  then                           
          aktuellerRaum.Enemy:=Baer;
     end;
	 
	if aktuellerRaum.Difficulty='Friedhof'
     then begin                                         
       if Wuerfel <= 20  then                           
          aktuellerRaum.Enemy:=nil
	...
	if aktuellerRaum.Difficulty='Waldstark'
     then begin                                         
       if Wuerfel <= 20  then                           
          aktuellerRaum.Enemy:=Bandit
	...
	if aktuellerRaum.Difficulty='Zufall'
     then begin                                         
       if Wuerfel <= 5  then                           
          aktuellerRaum.Enemy:=Ork
