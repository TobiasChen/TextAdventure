...
begin
   ...
   Grosse_Blumenwiese			:=TRaum.create('Große Blumenwiese','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Kaserne						:=TRaum.create('Kaserne','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Schlafgemach					:=TRaum.create('Schlafgemach','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Einsame_Herberge				:=TRaum.create('Einsame Herberge','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Graumoor						:=TRaum.create('Graumoor','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Schattenweiden				:=TRaum.create('Schattenweiden','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Westweg						:=TRaum.create('Westweg','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Bruecke						:=TRaum.create('Brücke','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Augvea						:=TRaum.create('Augvea','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Ostweg						:=TRaum.create('Ostweg','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Oestliche_Huegel				:=TRaum.create('Östliche Hügel','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Verlassene_Burg				:=TRaum.create('Verlassene Burg','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
   Wachturm						:=TRaum.create('Wachturm','to quickly create Rooms',nil,nil,nil,nil,nil,'','','','',0,'',0,0,0,false,false);
